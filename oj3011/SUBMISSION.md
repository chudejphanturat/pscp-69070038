...
```text
input เป็นแม่สีผสม 2 สีแล้วเอามาเทียบกันใน if else เพื่อผสมสีและถ้าไม่มีสีนั้นให้ขึ้นเป็น error
```
...
```text
Step 1:input สี 1 สี 2
Step 2:if else เทียบสีทั้งหน้าและหลัง แล้ว output
```
...
```text
code ก่อนหน้าต้องเขียนหลายบรรทัดเพราะมีหลาย condition
Step 1:input สี 1 สี 2
Step 2:ใส่ใน list 
Step 3:เทียบว่ามีอยู่ใน condition แล้ว output เป็นสีผสมและดูว่ามีสีซ้ำไหมให้ output เป็นตัวสีเดิม
```
